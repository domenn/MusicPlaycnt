...
GT_DL_VER=v1.10.x
GT_DL_LINK=https://github.com/google/googletest/archive/${GT_DL_VER}.zip
GT_ZIP_BASE_NAME=googletest
...
curl -SsLO $GT_DL_LINK && unzip -oq ${GT_DL_VER}.zip && rm -rf ${GT_DL_VER}.zip  \
 && \
cd ${GT_ZIP_BASE_NAME}-${GT_DL_VER}  \
