...
LOCALLY_SCOPED_M_AW_CPP_CHAR_CONST(DEFAULT_DATA_FILE_NAME, "app_data.txt")
LOCALLY_SCOPED_M_AW_CPP_CHAR_CONST(DEFAULT_OSTREAM_SONG, " {artist} - {title} ({album})\n ({path})")
LOCALLY_SCOPED_M_AW_CPP_CHAR_CONST(LISTENER_THREAD_NAME, "ThFileChListn")

//LOCALLY_SCOPED_M_AW_CPP_CHAR_CONST(KW_TOKEN_ARTIST, "{artist}")
//LOCALLY_SCOPED_M_AW_CPP_CHAR_CONST(KW_TOKEN_T, "{title}")
//LOCALLY_SCOPED_M_AW_CPP_CHAR_CONST(KW_TOKEN_AL, "{album}")
//LOCALLY_SCOPED_M_AW_CPP_CHAR_CONST(KW_TOKEN_P, "{path}")
